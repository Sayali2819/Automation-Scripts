describe("Positive Sequence", () => {
    ...
    const nameD = "Aaryan";
    const mobile = "6785711203";
    const city = "Mumbai";
    const businessType = "Charity";
    const businessCategory = "Finance"
    const companyName = "20wiftTide Solutions";
    const address = "123 Tech Park, Suite 501, Mumbai, Maharashtra";
...
function runRegistrationTest() {
  ...
  function editDetails(){
    ...
    // const businessTypeXpath = ':nth-child(2) > ion-grid.md > ion-row.md > :nth-child(1) > .ng-pristine';
    // const businessTypeXpath = '//ion-select//label//div[contains(@class, "native wrapper")]//div[contains(@class, "select-text")]'
    // const businessTypeXpath = '/html/body/app-root/ion-app/ion-router-outlet/app-profile-form/ion-content/ion-list/ion-item-group[2]/ion-grid/ion-row/ion-col[1]/ion-select//label/div[3]/div';
    // const businessCatXpath = ':nth-child(2) > .ng-untouched';
